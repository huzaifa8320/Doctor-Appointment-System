        ...
        <nav className="bg-[#1E3A8A] fixed w-full z-10 p-1">
            <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-16">
                <div className="relative flex h-16 items-center justify-between">
                    ...
                    <div className="flex flex-1 items-center sm:justify-between justify-between">
                        ...
                        <div className="hidden ms-auto sm:ml-6 md:block">
                        ...
                        <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                            ...
                            {session ?
                                ...
                                <Link href={'/account'} className="py-1 px-5 border-2 border-white  bg-white text-[#1E3A8A] font-semibold rounded-lg shadow-md hover:bg-[#1E3A8A] hover:text-white transition-all">
                                    Login
                                </Link>
                            }
            ...
            <div className={`${isMobileMenuOpen ? 'max-h-screen' : 'max-h-0'} sm:hidden overflow-hidden transition-all duration-300 ease-in-out`}>
                <div className="space-y-1 px-2 pb-3 pt-2">
                    ...
                    <Link onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)} href="/appointments" className={`block rounded-md px-5 py-2 ${pathname == '/appointments' && 'bg-blue-600 text-white'} text-sm font-medium text-gray-300 hover:bg-blue-700 hover:text-white`}>
                        Appointments
                    </Link>
                    <Link onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)} href="/contact-us" className={`block rounded-md px-5 py-2 ${pathname == '/contact-us' && 'bg-blue-600 text-white'} text-sm font-medium text-gray-300 hover:bg-blue-700 hover:text-white`}>
                        Contact Us
                    </Link>
                </div>
            </div>
